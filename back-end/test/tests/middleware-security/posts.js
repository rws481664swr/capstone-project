...
describe('posts middleware security', () => {
        ...
        it('get post by id if in course or admin/teacher ', async () => {
            should.fail('todo')
        })
        ...
        it('can get users in course if enrolled or admin ', async () => {
            should.fail('todo')
        })
        it('can get users in course if teaching or admin ', async () => {
            should.fail('todo')
        })

        it('can create post if create post if in course (student) or admin', async () => {
            should.fail('todo')
        })
        it('can create post if create post if in course (teacher) or admin', async () => {
            should.fail('todo')
        })
        ...
        it('can delete post if owner, teacher or admin', async () => {
            should.fail('todo')
        })

        it('cannot pin a post as a user', async () => {
            should.fail('todo')
        })
    }
)